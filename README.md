...
- **Web-auth**
  - JWT/refresh + Telegram Login linking
  - Можливість користувачу заходити на сайт і бачити ті самі цілі

- **Надійність API**
  - Idempotency key для `POST /progress` (щоб дубль-кліки не множили записи)
  - Rate limiting, audit log

---

## Наступний крок
Якщо хочеш — наступним кроком зафіксую DTO/схеми запитів-відповідей (OpenAPI-style) і список валідацій/помилок (`400/401/403/409`) під ці правила.

## Примітка
Це тестова зміна у README для перевірки процесу PR.
